...
// in simulator we redefine to format for jsOAuthTestSuite Developer console
...
{\
	NSString * exceptionName = [@"org.jsoauthtestsuite." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.jsoauthtestsuite";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIjsOAuthTestSuiteNativeItemNone = -1, 
	UIjsOAuthTestSuiteNativeItemSpinner = -2,
	UIjsOAuthTestSuiteNativeItemProgressBar = -3,
	
	UIjsOAuthTestSuiteNativeItemSlider = -4,
	UIjsOAuthTestSuiteNativeItemSwitch = -5,
	UIjsOAuthTestSuiteNativeItemMultiButton = -6,
	UIjsOAuthTestSuiteNativeItemSegmented = -7,
	
	UIjsOAuthTestSuiteNativeItemTextView = -8,
	UIjsOAuthTestSuiteNativeItemTextField = -9,
	UIjsOAuthTestSuiteNativeItemSearchBar = -10,
	
	UIjsOAuthTestSuiteNativeItemPicker = -11,
	UIjsOAuthTestSuiteNativeItemDatePicker = -12,
	
	UIjsOAuthTestSuiteNativeItemInfoLight = -13,
	UIjsOAuthTestSuiteNativeItemInfoDark = -14,
	
	UIjsOAuthTestSuiteNativeItemDisclosure = -15,
	
	UIjsOAuthTestSuiteNativeItemContactAdd = -16
};
