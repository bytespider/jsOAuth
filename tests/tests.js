...
if (typeof fireunit != 'undefined') {
    ...
    // test url generation
    fireunit.compare('This%20string%20has%20spaces%2Astars%2F%5Cslashes%22quotes%3Acolons.periods%3Dequals%26ampersands', Uri.QueryString.urlEncode('This string has spaces*stars/\\slashes"quotes:colons.periods=equals&ampersands'), 'urlEncode encodes string correctly');
